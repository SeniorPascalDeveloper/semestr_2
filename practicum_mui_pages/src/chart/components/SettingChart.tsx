...
function SettingChart({ series, setSeries, isBar, setIsBar }: CheckboxProps) {
  ...
  /* самостоятельное задание 7.1: обработка change на radio */
  ...
  return (
            ...
            spacing={2}
            sx={{ m: "20px 0", justifyContent: "center" }} // ✅ Moved to sx
        >
      {/* Группа radio — тип диаграммы */}
      <FormControl>
